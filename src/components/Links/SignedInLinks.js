    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <li className={classes}><NavLink to='/dodaj_zadanie'>Dodaj zadanie</NavLink></li>
                <li className={classes}><NavLink to='/dodaj_powiadomienie'>Dodaj powiadomienie</NavLink></li>
                ...
                <li><a href="#!" onClick={this.props.logOut}>Wyloguj się</a></li>
            </React.Fragment>
        )
    }
}
